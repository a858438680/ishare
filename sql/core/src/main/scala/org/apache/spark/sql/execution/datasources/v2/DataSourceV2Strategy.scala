...
import org.apache.spark.sql.{sources, SlothDBContext, Strategy}
import org.apache.spark.sql.catalyst.expressions.{And, AttributeReference, AttributeSet, Expression}
import org.apache.spark.sql.catalyst.planning.PhysicalOperation
import org.apache.spark.sql.catalyst.plans.logical.{AppendData, LogicalPlan, Repartition}
import org.apache.spark.sql.execution.{FilterExec, ProjectExec, SlothProjectExec, SparkPlan}
...
object DataSourceV2Strategy extends Strategy {
  ...
  override def apply(plan: LogicalPlan): Seq[SparkPlan] = plan match {
    case PhysicalOperation(project, filters, relation: DataSourceV2Relation) =>
      ...
      if (SlothDBContext.enable_slothdb) SlothProjectExec(project, withFilter) :: Nil
      else ProjectExec(project, withFilter) :: Nil
